  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen bg-neutral-900 text-white mx-auto max-w-7xl p-8">
        {/* Navigation */}
        <nav className={`${isLoaded ? 'slide-down' : 'opacity-0'}`} style={{ animationDelay: '0s' }}>
        ...
        <main className="flex-1 my-12 text-center">
          {/* Hero Section */}
          <div className={`pb-8 ${isLoaded ? 'slide-up' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
          ...
          {/* Download Section */}
          <div className={`pb-8 ${isLoaded ? 'scale-in' : 'opacity-0'}`} style={{ animationDelay: '0.4s' }}>
            <a 
          ...
          <div className="scroll-animate py-8 flex flex-col items-center justify-center gap-x-12 gap-y-6 lg:flex-row">
          ...
          <div className="scroll-animate py-8 flex flex-col items-center justify-center gap-x-12 gap-y-6 lg:flex-row-reverse">
          ...
          {/* Footer Info */}
          <div className="scroll-animate py-12">
            <p className="mb-2">
        ...
        {/* Footer */}
        <footer className="scroll-animate text-center">
